...
class OperationHelper(BasePage):
    ...
    def click_new_post_button(self):
        self.click_button(TestSearchLocators.ids['LOCATOR_BTN_NEW_POST'], description="new post")

    def click_save_new_post(self):
        self.click_button(TestSearchLocators.ids['LOCATOR_BTNSAVE_NEW_POST'], description="save post")
    ...
    def click_button_contact_us(self):
        self.click_button(TestSearchLocators.ids['LOCATOR_CONTACT_US_BUTTON'], description="Contact us")
